...
# Header
st.title("Books Recommender System using Machine Learning")

model = pickle.load(open('artifacts/model.pkl','rb'))
book_name = pickle.load(open('artifacts/book_name.pkl','rb'))
final_df = pickle.load(open('artifacts/final_df.pkl','rb'))
pivot_table = pickle.load(open('artifacts/df_pivot_table.pkl','rb'))
